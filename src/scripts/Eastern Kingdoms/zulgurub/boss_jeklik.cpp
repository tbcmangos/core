...
static float batLocations[BAT_COUNT][3] = {
        {-12291.6220f, -1380.2640f, 144.8304f},
        {-12289.6220f, -1380.2640f, 144.8304f},
        {-12293.6220f, -1380.2640f, 144.8304f},
        {-12291.6220f, -1380.2640f, 144.8304f},
        {-12289.6220f, -1380.2640f, 144.8304f},
        {-12293.6220f, -1380.2640f, 144.8304f}};
...
struct boss_jeklikAI : public ScriptedAI
{
    ...
    int32 Charge_Timer;
    int32 SonicBurst_Timer;
    int32 Screech_Timer;
    int32 SpawnBats_Timer;
    int32 ShadowWordPain_Timer;
    int32 MindFlay_Timer;
    int32 ChainMindFlay_Timer;
    int32 GreaterHeal_Timer;
    int32 SpawnFlyingBats_Timer;
