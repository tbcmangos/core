...
static float SpawnPointSpecial[3][3]=
{
...
static float JainaDummySpawn[2][4]=
{
...
static float JainaWPs[2][3]=
{
    {5078.56f,    -1789.79f,    1320.73f},//next to the small stairs
    {5037.38f,    -1778.39f,    1322.61f},//center of alliance base
};

static float InfernalPos[8][3]=//spawn points for the infernals in the horde base
{
...
static float InfernalSPWP[26][4]=//spawn points for the infernals in the horde base used in the cleaning wave
{
...
static float VeinPos[14][8]=//spawn points of the ancient gem veins
{
...
static float AllianceOverrunGargPos[5][4]=//gargoyle spawn points in the alliance overrun
{
...
static float AllianceFirePos[92][8]=//spawn points for the fire visuals (GO) in the alliance base
{
...
static float HordeFirePos[65][8]=//spawn points for the fire visuals (GO) in the horde base
{
