...
bool OPvPCapturePointZM_GraveYard::CanTalkTo(Player * plr, Creature * c, GossipOption & gso)
{
    ...
    if (itr != m_CreatureTypes.end())
    {
        ...
        {
            gso.OptionText.assign(sObjectMgr.GetMangosStringForDBCLocale(LANG_OPVP_ZM_GOSSIP_ALLIANCE));
            return true;
        }
        ...
        {
            gso.OptionText.assign(sObjectMgr.GetMangosStringForDBCLocale(LANG_OPVP_ZM_GOSSIP_HORDE));
            return true;
        }
    }
    return false;
