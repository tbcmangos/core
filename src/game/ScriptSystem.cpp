...
void SystemMgr::LoadVersion()
{
    ...
    QueryResult* pResult = GameDataDatabase.PQuery("SELECT script_version FROM version LIMIT 1");
...
void SystemMgr::LoadScriptTexts()
{
    ...
    QueryResult* pResult = GameDataDatabase.PQuery("SELECT entry, sound, type, language, emote FROM script_texts");
...
void SystemMgr::LoadScriptTextsCustom()
{
    ...
    QueryResult* pResult = GameDataDatabase.PQuery("SELECT entry, sound, type, language, emote FROM custom_texts");
...
void SystemMgr::LoadScriptWaypoints()
{
    ...
    // Load Waypoints
    QueryResult* pResult = GameDataDatabase.PQuery("SELECT COUNT(entry) FROM script_waypoint GROUP BY entry");
    if (pResult)
    {
