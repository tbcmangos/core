...
UPDATE `creature_template` SET `npcflag` = '0' WHERE entry = '22432';
...
UPDATE `creature_template` SET `MovementType` = '0' WHERE entry = '22505';
UPDATE `quest_template` SET `ReqSpellCast1`  = '0' WHERE entry = '10935';
UPDATE `quest_template` SET `ReqCreatureOrGOID1`  = '22432' WHERE entry = '10935';
UPDATE `quest_template` SET `ReqCreatureOrGOCount1`  = '1' WHERE entry = '10935';
UPDATE `quest_template` SET `QuestFlags` = '128' WHERE entry = '10935';
UPDATE `quest_template` SET `SpecialFlags`  = '0' WHERE entry = '10935';
...
INSERT INTO creature_ai_scripts VALUES ('2250502', '22505', '1', '0', '100', '0', '1000', '1000', '0', '0', '12', '22506', '0', '600000', '0', '0', '0', '0', '0', '0', '0', '0', 'Slimer Bunny - Summon Foul Purge on Spawn');
